...
extern "C"
{
												...
												const char			*inHostVersion)
	{
		...
		result = PF_REGISTER_EFFECT(
			...
			"Emitter",					// Name
			"ADBE PopcornFX Emitter",	// Match Name
			"PopcornFX",				// Category
					...
					void			*extra)
{
	...
	try
	{
		...
		case	PF_Cmd_USER_CHANGED_PARAM:
			result = AEPlugin.ParamValueChanged(AAEData, params);
			break;
		//UI thread
		...
		case	PF_Cmd_QUERY_DYNAMIC_FLAGS:
			result = AEPlugin.QueryDynamicFlags(AAEData, params);
			break;
		default:
			break;
		}
...
#endif
	if (AAEData.m_ReturnCode != PF_Err_NONE)
		return AAEData.m_ReturnCode;
	return result;
}
