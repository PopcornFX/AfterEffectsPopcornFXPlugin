...
bitsadmin /addfile third_party_download http://downloads.popcornfx.com/Plugins/ExternalLibs/ExternalLibs_AfterEffects_2.25.2-27973_x64_vs2022_macosx.zip "%OPEN_SOURCE_AE_REPO_PATH%ExternalLibs.zip"
