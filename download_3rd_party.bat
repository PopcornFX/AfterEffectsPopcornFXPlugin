...
bitsadmin /addfile third_party_download http://downloads.popcornfx.com/Plugins/ExternalLibs/ExternalLibs_AfterEffects_2.19.6-21661_x64_macosx_vs2019.zip "%OPEN_SOURCE_AE_REPO_PATH%ExternalLibs.zip"
