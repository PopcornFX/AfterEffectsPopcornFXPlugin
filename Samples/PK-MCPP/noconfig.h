...
#if	(PK_OS == PK_OS_WINDOWS)
#	define SYSTEM              SYS_WIN
#elif (PK_OS == PK_OS_MACOSX)
#	define SYSTEM              SYS_MAC
#elif (PK_OS == PK_OS_LINUX)
#	define SYSTEM              SYS_LINUX
#else
#	error	"Unknown OS for MCPP"
#endif
...
#else
#	error	"Unknown compiler for MCPP"
#endif
...
/* stdin, stdout, stderr, SIOHandle, NULL, fgets(), fputs() and other functions. */
#include    "stdio.h"
...
#if     defined(KMMALLOC) && _MEM_DEBUG
#include        "xalloc.h"
#endif
