...
class	CGLSLShaderGenerator : public CAbstractShaderGenerator
{
public:
	CGLSLShaderGenerator() : m_IsOpenGLES(false), m_UseMediumPrecision(false) {}
	virtual ~CGLSLShaderGenerator() {}


protected:
	bool		m_IsOpenGLES;
	bool		m_UseMediumPrecision;
...
class	CGLSLESShaderGenerator : public CGLSLShaderGenerator
{
public:
	CGLSLESShaderGenerator(bool isMediumPrecision = true)
	{
		m_IsOpenGLES = true;
		m_UseMediumPrecision = isMediumPrecision;
	}
	virtual ~CGLSLESShaderGenerator() {}
};
