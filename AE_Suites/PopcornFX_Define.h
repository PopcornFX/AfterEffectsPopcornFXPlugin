...
static_assert(AEPOPCORNFX_PIPL_VERSION == ((AEPOPCORNFX_MAJOR_VERSION << 24) | (AEPOPCORNFX_MINOR_VERSION << 16) | (AEPOPCORNFX_BUG_VERSION << 8) | AEPOPCORNFX_BUILD_VERSION), "AEPOPCORNFX_PIPL_VERSION is out of date");
