...
wget "http://downloads.popcornfx.com/Plugins/ExternalLibs/ExternalLibs_AfterEffects_2.25.2-27973_x64_vs2022_macosx.zip" -O "$OPEN_SOURCE_AE_REPO_PATH/ExternalLibs.zip"
