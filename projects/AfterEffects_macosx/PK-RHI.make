...
INCLUDES += -I../../ExternalLibs/Runtime -I../../ExternalLibs/Runtime/include -I../../ExternalLibs/Runtime/include/license/AfterEffects -I../../ExternalLibs/Runtime/pk_rhi/include -I../../ExternalLibs/Runtime/pk_rhi/src -I../../ExternalLibs/Runtime/pk_rhi/src/precompiled -I../../Samples/Common -I../../ExternalLibs/GL/include
FORCE_INCLUDE +=
...
OBJDIR = ../intermediate/AfterEffects/GM/x64/Debug/PK-RHI
DEFINES += -D_DEBUG -DPK_COMPILER_BUILD_COMPILER_D3D11=1 -DPK_COMPILER_BUILD_COMPILER_D3D12=1 -DPK_BUILD_WITH_METAL_SUPPORT=1 -DPK_BUILD_WITH_OGL_SUPPORT=1 -DGL_GLEXT_PROTOTYPES -DGLEW_STATIC -DGLEW_NO_GLU
...
OBJDIR = ../intermediate/AfterEffects/GM/x64/Release/PK-RHI
DEFINES += -DNDEBUG -DPK_COMPILER_BUILD_COMPILER_D3D11=1 -DPK_COMPILER_BUILD_COMPILER_D3D12=1 -DPK_BUILD_WITH_METAL_SUPPORT=1 -DPK_BUILD_WITH_OGL_SUPPORT=1 -DGL_GLEXT_PROTOTYPES -DGLEW_STATIC -DGLEW_NO_GLU
...
OBJDIR = ../intermediate/AfterEffects/GM/x64/Retail/PK-RHI
DEFINES += -DNDEBUG -DPK_RETAIL -DPK_COMPILER_BUILD_COMPILER_D3D11=1 -DPK_COMPILER_BUILD_COMPILER_D3D12=1 -DPK_BUILD_WITH_METAL_SUPPORT=1 -DPK_BUILD_WITH_OGL_SUPPORT=1 -DGL_GLEXT_PROTOTYPES -DGLEW_STATIC -DGLEW_NO_GLU
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -Wshadow -Wundef -ffast-math -fomit-frame-pointer -O3 -fno-strict-aliasing -msse2 -fvisibility=hidden -Wall -Wextra -Winvalid-pch -Wno-pragma-pack -fno-finite-math-only -fsigned-zeros -mrecip=!sqrt -mfpmath=sse -target x86_64-apple-macos10.15 -iwithsysroot `xcrun --show-sdk-path`
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -Wshadow -Wundef -ffast-math -fomit-frame-pointer -O3 -fno-strict-aliasing -msse2 -fvisibility=hidden -Wall -Wextra -std=c++17 -fno-exceptions -fno-rtti -Winvalid-pch -Wno-pragma-pack -fno-finite-math-only -fsigned-zeros -mrecip=!sqrt -mfpmath=sse -target x86_64-apple-macos10.15 -iwithsysroot `xcrun --show-sdk-path`
...
PERFILE_FLAGS_1 = $(ALL_CXXFLAGS) -fvisibility-inlines-hidden -include pk_compiler_warnings.h
PERFILE_FLAGS_2 = $(ALL_CXXFLAGS) -fvisibility-inlines-hidden -Wno-unguarded-availability-new -include pk_compiler_warnings.h
...
GENERATED += $(OBJDIR)/MetalApiManager.o
GENERATED += $(OBJDIR)/MetalCommandBuffer.o
GENERATED += $(OBJDIR)/MetalComputeState.o
GENERATED += $(OBJDIR)/MetalConstantSampler.o
GENERATED += $(OBJDIR)/MetalConstantSet.o
GENERATED += $(OBJDIR)/MetalFrameBuffer.o
GENERATED += $(OBJDIR)/MetalGpuBuffer.o
GENERATED += $(OBJDIR)/MetalPopcornEnumConversion.o
GENERATED += $(OBJDIR)/MetalReadBackTexture.o
GENERATED += $(OBJDIR)/MetalRenderPass.o
GENERATED += $(OBJDIR)/MetalRenderState.o
GENERATED += $(OBJDIR)/MetalRenderTarget.o
GENERATED += $(OBJDIR)/MetalShaderModule.o
GENERATED += $(OBJDIR)/MetalShaderProgram.o
GENERATED += $(OBJDIR)/MetalTexture.o
...
OBJECTS += $(OBJDIR)/MetalApiManager.o
OBJECTS += $(OBJDIR)/MetalCommandBuffer.o
OBJECTS += $(OBJDIR)/MetalComputeState.o
OBJECTS += $(OBJDIR)/MetalConstantSampler.o
OBJECTS += $(OBJDIR)/MetalConstantSet.o
OBJECTS += $(OBJDIR)/MetalFrameBuffer.o
OBJECTS += $(OBJDIR)/MetalGpuBuffer.o
OBJECTS += $(OBJDIR)/MetalPopcornEnumConversion.o
OBJECTS += $(OBJDIR)/MetalReadBackTexture.o
OBJECTS += $(OBJDIR)/MetalRenderPass.o
OBJECTS += $(OBJDIR)/MetalRenderState.o
OBJECTS += $(OBJDIR)/MetalRenderTarget.o
OBJECTS += $(OBJDIR)/MetalShaderModule.o
OBJECTS += $(OBJDIR)/MetalShaderProgram.o
OBJECTS += $(OBJDIR)/MetalTexture.o
...
$(GCH): $(PCH) | prebuild
	@echo $(notdir $<)
	$(SILENT) $(CXX) -x c++-header $(PERFILE_FLAGS_1) -o "$@" -MF "$(@:%.gch=%.d)" -c "$<"
...
$(OBJDIR)/AbstractTexture.o: ../../ExternalLibs/Runtime/pk_rhi/src/interfaces/abstracts/AbstractTexture.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) -include $(PCH_PLACEHOLDER) $(PERFILE_FLAGS_1) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/MetalApiManager.o: ../../ExternalLibs/Runtime/pk_rhi/src/metal/MetalApiManager.mm
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(PERFILE_FLAGS_2) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/MetalCommandBuffer.o: ../../ExternalLibs/Runtime/pk_rhi/src/metal/MetalCommandBuffer.mm
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(PERFILE_FLAGS_2) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/MetalComputeState.o: ../../ExternalLibs/Runtime/pk_rhi/src/metal/MetalComputeState.mm
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(PERFILE_FLAGS_2) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/MetalConstantSampler.o: ../../ExternalLibs/Runtime/pk_rhi/src/metal/MetalConstantSampler.mm
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(PERFILE_FLAGS_2) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/MetalConstantSet.o: ../../ExternalLibs/Runtime/pk_rhi/src/metal/MetalConstantSet.mm
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(PERFILE_FLAGS_2) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/MetalFrameBuffer.o: ../../ExternalLibs/Runtime/pk_rhi/src/metal/MetalFrameBuffer.mm
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(PERFILE_FLAGS_2) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/MetalGpuBuffer.o: ../../ExternalLibs/Runtime/pk_rhi/src/metal/MetalGpuBuffer.mm
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(PERFILE_FLAGS_2) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/MetalPopcornEnumConversion.o: ../../ExternalLibs/Runtime/pk_rhi/src/metal/MetalPopcornEnumConversion.mm
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(PERFILE_FLAGS_2) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/MetalReadBackTexture.o: ../../ExternalLibs/Runtime/pk_rhi/src/metal/MetalReadBackTexture.mm
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(PERFILE_FLAGS_2) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/MetalRenderPass.o: ../../ExternalLibs/Runtime/pk_rhi/src/metal/MetalRenderPass.mm
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(PERFILE_FLAGS_2) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/MetalRenderState.o: ../../ExternalLibs/Runtime/pk_rhi/src/metal/MetalRenderState.mm
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(PERFILE_FLAGS_2) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/MetalRenderTarget.o: ../../ExternalLibs/Runtime/pk_rhi/src/metal/MetalRenderTarget.mm
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(PERFILE_FLAGS_2) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/MetalShaderModule.o: ../../ExternalLibs/Runtime/pk_rhi/src/metal/MetalShaderModule.mm
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(PERFILE_FLAGS_2) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/MetalShaderProgram.o: ../../ExternalLibs/Runtime/pk_rhi/src/metal/MetalShaderProgram.mm
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(PERFILE_FLAGS_2) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/MetalTexture.o: ../../ExternalLibs/Runtime/pk_rhi/src/metal/MetalTexture.mm
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(PERFILE_FLAGS_2) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
