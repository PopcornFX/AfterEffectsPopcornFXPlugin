...
INCLUDES += -I../../ExternalLibs/Runtime -I../../ExternalLibs/Runtime/include -I../../ExternalLibs/Runtime/include/license/AfterEffects -I../../Samples/PK-Sample_08_CustomCollision -I../../Samples/precompiled -I../../Samples/PK-Sample_02_FullIntegration/Scene -I../../Samples -I../../ExternalLibs/GL/include -I../../ExternalLibs/imgui -I/usr/local/include/SDL2
FORCE_INCLUDE +=
...
OBJDIR = ../intermediate/AfterEffects/GM/x64/Debug/PK-Sample_08_CustomCollision
...
OBJDIR = ../intermediate/AfterEffects/GM/x64/Release/PK-Sample_08_CustomCollision
...
OBJDIR = ../intermediate/AfterEffects/GM/x64/Retail/PK-Sample_08_CustomCollision
...
$(OBJDIR)/CustomCollision.o: ../../Samples/PK-Sample_08_CustomCollision/CustomCollision.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) -include $(PCH_PLACEHOLDER) $(PERFILE_FLAGS_0) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/CustomCollision_Scene.o: ../../Samples/PK-Sample_08_CustomCollision/CustomCollision_Scene.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) -include $(PCH_PLACEHOLDER) $(PERFILE_FLAGS_0) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/CustomCollision_SimInterface_Decl.o: ../../Samples/PK-Sample_08_CustomCollision/CustomCollision_SimInterface_Decl.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) -include $(PCH_PLACEHOLDER) $(PERFILE_FLAGS_0) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/CustomCollision_SimInterface_Impl.o: ../../Samples/PK-Sample_08_CustomCollision/CustomCollision_SimInterface_Impl.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) -include $(PCH_PLACEHOLDER) $(PERFILE_FLAGS_0) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Main.o: ../../Samples/PK-Sample_08_CustomCollision/Main.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) -include $(PCH_PLACEHOLDER) $(PERFILE_FLAGS_0) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
