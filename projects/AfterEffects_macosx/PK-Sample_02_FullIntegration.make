...
INCLUDES += -I../../Samples/PK-Sample_02_FullIntegration -I../../Samples/precompiled -I../../Samples -I../../ExternalLibs/Runtime -I../../ExternalLibs/Runtime/include -I../../ExternalLibs/Runtime/include/license/AfterEffects -I../../SDK/Samples/ParticleSample/src -I../../ExternalLibs/pk_upgraderlib/src/include -I../../SDK/Samples/Common/PKFX -I../../ExternalLibs/GL/include -I../../ExternalLibs/imgui -I/usr/local/include/SDL2
FORCE_INCLUDE +=
...
TARGET = $(TARGETDIR)/PK-Sample_02_FullIntegration_macosx_d
OBJDIR = ../intermediate/AfterEffects/GM/x64/Debug/PK-Sample_02_FullIntegration
DEFINES += -D_DEBUG -DPK_COMPILER_BUILD_COMPILER_D3D11=1 -DPK_COMPILER_BUILD_COMPILER_D3D12=1 -DPKSAMPLE_PROJNAME=PK-Sample_02_FullIntegration -DPK_BUILD_WITH_METAL_SUPPORT=1 -DPK_BUILD_WITH_OGL_SUPPORT=1 -DGL_GLEXT_PROTOTYPES -DGLEW_STATIC -DGLEW_NO_GLU -DPK_BUILD_WITH_FMODEX_SUPPORT=0 -DPK_BUILD_WITH_SDL=0 -DMACOSX
...
TARGETDIR = ../../../release/builds/x64_Samples
TARGET = $(TARGETDIR)/PK-Sample_02_FullIntegration_macosx_r
OBJDIR = ../intermediate/AfterEffects/GM/x64/Release/PK-Sample_02_FullIntegration
...
TARGETDIR = ../../../release/builds/x64_Samples
TARGET = $(TARGETDIR)/PK-Sample_02_FullIntegration_macosx_s
OBJDIR = ../intermediate/AfterEffects/GM/x64/Retail/PK-Sample_02_FullIntegration
...
$(OBJDIR)/FxPlatformGeneric.o: ../../SDK/Samples/Common/PKFX/FxPlatformGeneric.cpp
	@echo "$(notdir $<)"
...
$(OBJDIR)/GPUContext_D3D.o: ../../Samples/PK-Sample_02_FullIntegration/GPUContext_D3D.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) -include $(PCH_PLACEHOLDER) $(PERFILE_FLAGS_0) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Main.o: ../../Samples/PK-Sample_02_FullIntegration/Main.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) -include $(PCH_PLACEHOLDER) $(PERFILE_FLAGS_0) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/PopcornScene.o: ../../Samples/PK-Sample_02_FullIntegration/Scene/PopcornScene.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) -include $(PCH_PLACEHOLDER) $(PERFILE_FLAGS_0) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
