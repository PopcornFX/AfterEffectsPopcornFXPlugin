...
ALL_LDFLAGS += $(LDFLAGS) -m64 -dynamiclib -Wl,-install_name,@rpath/libAE_Effect_Attribute_d -Wl,-undefined,error -target x86_64-apple-macos10.15 -framework OpenGL
...
ALL_LDFLAGS += $(LDFLAGS) -m64 -dynamiclib -Wl,-install_name,@rpath/libAE_Effect_Attribute_r -Wl,-undefined,error -target x86_64-apple-macos10.15 -framework OpenGL
