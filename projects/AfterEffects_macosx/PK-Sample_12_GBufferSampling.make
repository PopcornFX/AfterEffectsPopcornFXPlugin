...
INCLUDES += -I../../ExternalLibs/Runtime -I../../ExternalLibs/Runtime/include -I../../ExternalLibs/Runtime/include/license/AfterEffects -I../../Samples/PK-Sample_12_GBufferSampling -I../../Samples/precompiled -I../../Samples/PK-Sample_02_FullIntegration/Scene -I../../Samples -I../../ExternalLibs/GL/include -I../../ExternalLibs/imgui -I/usr/local/include/SDL2
FORCE_INCLUDE +=
...
TARGET = $(TARGETDIR)/PK-Sample_12_GBufferSampling_macosx_d
OBJDIR = ../intermediate/AfterEffects/GM/x64/Debug/PK-Sample_12_GBufferSampling
DEFINES += -D_DEBUG -DPK_COMPILER_BUILD_COMPILER_D3D11=1 -DPK_COMPILER_BUILD_COMPILER_D3D12=1 -DPKSAMPLE_PROJNAME=PK-Sample_12_GBufferSampling -DPK_BUILD_WITH_METAL_SUPPORT=1 -DPK_BUILD_WITH_OGL_SUPPORT=1 -DGL_GLEXT_PROTOTYPES -DGLEW_STATIC -DGLEW_NO_GLU -DPK_BUILD_WITH_FMODEX_SUPPORT=0 -DPK_BUILD_WITH_SDL=0 -DMACOSX
...
TARGETDIR = ../../../release/builds/x64_Samples
TARGET = $(TARGETDIR)/PK-Sample_12_GBufferSampling_macosx_r
OBJDIR = ../intermediate/AfterEffects/GM/x64/Release/PK-Sample_12_GBufferSampling
...
TARGETDIR = ../../../release/builds/x64_Samples
TARGET = $(TARGETDIR)/PK-Sample_12_GBufferSampling_macosx_s
OBJDIR = ../intermediate/AfterEffects/GM/x64/Retail/PK-Sample_12_GBufferSampling
...
$(OBJDIR)/Main.o: ../../Samples/PK-Sample_12_GBufferSampling/Main.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) -include $(PCH_PLACEHOLDER) $(PERFILE_FLAGS_0) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/PK-Sample_12_GBufferSampling.o: ../../Samples/PK-Sample_12_GBufferSampling/PK-Sample_12_GBufferSampling.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) -include $(PCH_PLACEHOLDER) $(PERFILE_FLAGS_0) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
